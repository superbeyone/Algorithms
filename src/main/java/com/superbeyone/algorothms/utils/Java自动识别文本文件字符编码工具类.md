...
public class EncordingTest {
    ...
    @Test
    public void testEncord() throws Exception {
    	File file = new File("F:\\test.csv");
    	String charset = EncodingDetect.getFileEncode(file);
         try (BufferedReader reader = new BufferedReader(new UnicodeReader(new FileInputStream(file), charset))) {
            String line;
...
- [UnicodeReader 工具类地址](https://blog.csdn.net/superbeyone/article/details/103036428)
